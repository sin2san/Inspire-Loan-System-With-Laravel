...
@section('main-content')
    <div class="error-page">
        ...
        <div class="error-content">
            ...
            <p>
                We could not find the page you were looking for. Meanwhile, you may return to <a @if(Auth::user()->hasRole('customer')) href="{{ url('customer/dashboard') }}" @else href="{{ url('admin/dashboard') }}" @endif>dashboard</a> or try using the search form.
            </p>
