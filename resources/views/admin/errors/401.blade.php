    ...
    <div class="error-page">
        ...
        <div class="error-content">
            ...
            <p>
                ...
                Meanwhile, you may <a @if(Auth::user()->hasRole('customer')) href="{{url('customer/dashboard')}}" @else href="{{url('admin/dashboard')}}" @endif>return to dashboard</a> or try using the search form.
            </p>
