...
@section('main-content')
    <div class="error-page">
        ...
        <div class="error-content">
            ...
            <p>
                Some arror found on the page/server. Meanwhile, you may return to <a @if(Auth::user()->hasRole('customer')) href="{{ url('customer/dashboard') }}" @else href="{{ url('admin/dashboard') }}" @endif>dashboard</a> or try using the search form.
            </p>
